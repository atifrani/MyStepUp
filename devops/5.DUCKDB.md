...
*  Créer un fichier people.py et copiez les lignes ci-dessous dans votre fichier.
...
*  Créer un fichier titanic.py et copiez les lignes ci-dessous dans votre fichier.
