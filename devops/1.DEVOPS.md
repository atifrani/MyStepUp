...
![alt text](images/cycleV.png)

Dans ce contexte, la séparation des responsabilités avait du sens :

**Les développeurs (DEV)** construisaient les applications, souvent sans jamais voir un serveur de production
**Les opérationnels (OPS)** maintenaient l’infrastructure, protégeant ces machines coûteuses des changements hasardeux
...
![alt text](images/murconfusion.png)
